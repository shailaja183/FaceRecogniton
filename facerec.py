...
#         self.model = model
#         tector = CascadedDetector(cascade_fn=cascade_filename, minNeighbors=5, scaleFactor=1.1)
#         self.cam = create_capture('test_1.avi')
...
#         #fo.write(self.model.subject_names[prediction]+"\n")
#         file_count=file_count+1
#         if(self.model.subject_names[prediction]=='Prarthana'):
...
#     end=time.time()
#     fps=(num_frames*2)/(end-start)
#     print('Frames per second count: ')
#     print(fps)
#     print(file_count)
#     print(true_count)
#     accuracy=(float(true_count)/float(file_count))*100
#     print('Accuracy: ')
#     print(accuracy)
#     #fo.close()
...
#     App(model=model,camera_id=options.camera_id,cascade_filename=options.cascade_filename).run()
